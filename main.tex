...
\documentclass[10pt,oneside]{ic_eee_thesis}
...
\title{Low-Bit Post-Training Quantization of Llama-3.2-3B-Instruct:
Comparative Evaluation of AWQ, SmoothQuant, W4A8 and NestQuant
}
\subtitle{} % use \subtitle{} to remove the subtitle
\author{Junyi Teng}
\cid{06042897}
\supervisor{Prof C. Ling} %UK: Dr no dot, prof has dot
\submityear{2026}
...
\input{chapters/Chapter2-Related Work and Literature Review}
\input{chapters/Chapter3-Methodology and Experimental Design}
\input{chapters/Chapter4-Experimental Results and Discussion}
\input{chapters/Chapter5-Future Work, Sustainability and Environmental Impact}
...
% Appendix chapter heading format:
% display "Appendix A", "Appendix B", "Appendix C"
% while retaining A, B, C internally for tables and references.
\begin{appendices}
...
\titleformat{\chapter}[display]
  {\normalfont\raggedleft\bfseries\color{ImperialBlue}}
  {\fontsize{42}{44}\selectfont Appendix~\thechapter}
  {12pt}
  {\Huge\raggedleft\color{ImperialBlue}}
...
\addcontentsline{toc}{chapter}{Use of Generative AI tools}
\markboth{Use of Generative AI tools}{Use of Generative AI tools}

OpenAI Codex was used to assist with code debugging during the project. ChatGPT was used to improve the grammar, clarity and readability of the dissertation and to assist with the creation of diagrams.
