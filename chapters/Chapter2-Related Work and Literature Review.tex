...
scaling with a low-rank approximation of the quantization error\cite{wu2023zeroquantfpleapforwardllms},
...
LLM.int8() retains selected outlier dimensions at higher precision\cite{ashkboos2024quarotoutlierfree4bitinference}.
...
independently\cite{liu2025spinquantllmquantizationlearned}.
...
codebooks adapted to the second-order statistics of the activations\cite{egiazarian2024extremecompressionlargelanguage}. The result is non-constructive and does
