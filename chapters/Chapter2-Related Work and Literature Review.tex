...
\cite{jacob2017quantizationtrainingneuralnetworks,zhu2024survey}.
...
\cite{jacob2017quantizationtrainingneuralnetworks}.
...
that reconstruction-based methods may overfit the calibration set
\cite{lin2026awqactivationawareweightquantization}. More recent work has
...
activation outliers through an equivalent channel-wise transformation
\cite{xiao2023icml-smoothquant}. Its central observation is that weights
...
\cite{xiao2023icml-smoothquant}. In this dissertation, SmoothQuant
...
\cite{savkin2025nestquantnestedlatticequantization}.
...
quantization error is included during the reconstruction procedure
\cite{savkin2025nestquantnestedlatticequantization}. This makes NestQuant
...
keys and values in addition to weights and activations
\cite{savkin2025nestquantnestedlatticequantization}. This broader scope is
